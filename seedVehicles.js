...
const seedData = async () => {
    try {
        ...
        const brands = [
            { name: 'BMW', image: 'https://static.vecteezy.com/system/resources/thumbnails/019/956/127/small/bmw-transparent-bmw-free-free-png.png', status: 'active' },
            { name: 'Tesla', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Tesla_logo.png/500px-Tesla_logo.png', status: 'active' },
            { name: 'Mercedes', image: 'https://images.seeklogo.com/logo-png/33/2/mercedes-benz-logo-png_seeklogo-332844.png', status: 'active' },
            { name: 'Audi', image: 'https://www.freepnglogos.com/uploads/audi-logo-21.png', status: 'active' }
        ];
